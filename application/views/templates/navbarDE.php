      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo base_url(); ?>UserPanel_Overview">Dashboard</a></li>
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url(); ?>UserSetting">Settings <span class="glyphicon glyphicon-cog"></span></a></li>
           <li class="divider"></li>
